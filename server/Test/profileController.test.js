  ...
  await request
    ...
    .then((data) => {
      ...
      expect(data.body).toEqual(
        "Testing the functionality of the biography 1 2 3"
      );
    });
});
...
test("Should update social media JSON", async () => {
  await request
    ...
    .set("Cookie", "token=" + token)
    .send([
      { site: "youtube", link: "www.youtube.com" },
      { site: "facebook", link: "www.facebook.com" },
    ])
    .expect(200)
    .then((data) => {
      expect(data).toBeDefined();
